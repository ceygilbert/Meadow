           ...
           <div className="relative z-10 flex flex-col justify-center p-6 sm:p-10 md:p-20">
             <div className="max-w-2xl animate-in fade-in slide-in-from-bottom duration-1000">
               ...
               <Link 
                 ...
                 className="inline-flex items-center gap-3 px-6 py-3 md:px-9 md:py-4 bg-[#e11d48] text-white rounded-full font-black text-xs md:text-sm uppercase tracking-wider md:tracking-widest shadow-xl group/btn w-fit opacity-50 cursor-not-allowed pointer-events-none"
               >
